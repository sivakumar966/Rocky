    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            ProductVM productVM = new ProductVM()
            {
                ...
                ApplicationTypeSelectList = _prodRepo.GetAllDropdownList(WC.AppliationTypeName)
            };
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            productVM.ApplicationTypeSelectList = _prodRepo.GetAllDropdownList(WC.AppliationTypeName);
            return View(productVM);
        ...
        public IActionResult Delete(int? id)
        {
            ...
            Product product = _prodRepo.FirstOrDefault(u => u.Id == id, "Category,ApplicationType");
